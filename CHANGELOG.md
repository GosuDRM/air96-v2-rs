...
- On any Windows PC that previously saw USB device not recognized: open Device
  Manager, View, Show Hidden Devices, uninstall all greyed-out NuPhy /
  Air96 V2 USB entries (or use USBDeview), then re-plug the keyboard.
